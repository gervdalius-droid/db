/* ════════════════════════════════════════════════════════════════════════════
 * CraftOS Invoices — COMMERCIAL config (becomes config.js in the
 * fabflow-invoices repo). Customer-only Supabase project, paywall ON, worker
 * logins scoped per company. Read by craftos.js, which wraps the invoicing app.
 * ════════════════════════════════════════════════════════════════════════════ */
window.FAB_CONFIG = {
